          ...
          <div className="space-y-24 md:space-y-32 py-12 md:py-20">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { icon: Heart, title: "Future Resonance", desc: "Engage in a temporal simulation with your future self, trained on your memories." },
                { icon: Mic, title: "Vocal Archive", desc: "Capture the raw frequency of your existence. Preserve the exact sound of your current self." },
                { icon: ShieldCheck, title: "Privacy Priority", desc: "Your data is end-to-end encrypted. Only your neural link can access your digital legacy." },
              ].map((f, i) => (
                <motion.div 
                  key={i}
